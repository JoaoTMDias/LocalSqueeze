...
describe("CompressionControls", () => {
  it("shows the selected quality and exposes a slider thumb", () => {
    ...
    render(<CompressionControls quality={80} scale={100} onQualityChange={onQualityChange} onScaleChange={vi.fn()} />)
  ...
  it("renders balanced as the default preset", () => {
    render(<CompressionControls quality={80} scale={100} onQualityChange={vi.fn()} onScaleChange={vi.fn()} />)
